# data compilation of unit level responses of childhood malnutrition
...
cluster = readRDS(file = here("data", "raw", "rdhs", "MDGE81FL.rds"))
...
write.csv2(bind_cols("#", label), file = here("src", "analysis", "madagascar", "questions.csv"))
...
# save
save(sv, nb, file = here("data", "processed", "madagascar", "surveydata.rda"))
