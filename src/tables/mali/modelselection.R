...
res[model %in% c("A1", "A2", "A3", "C"), q0025 := qBB(0.025, bd = n, mu = mu, sigma = sigma, lower.tail = TRUE, log.p = FALSE)]
res[model %in% c("A1", "A2", "A3", "C"), q005 := qBB(0.05, bd = n, mu = mu, sigma = sigma, lower.tail = TRUE, log.p = FALSE)]
res[model %in% c("A1", "A2", "A3", "C"), q010 := qBB(0.10, bd = n, mu = mu, sigma = sigma, lower.tail = TRUE, log.p = FALSE)]
res[model %in% c("A1", "A2", "A3", "C"), q025 := qBB(0.25, bd = n, mu = mu, sigma = sigma, lower.tail = TRUE, log.p = FALSE)]
res[model %in% c("A1", "A2", "A3", "C"), q075 := qBB(0.75, bd = n, mu = mu, sigma = sigma, lower.tail = TRUE, log.p = FALSE)]
res[model %in% c("A1", "A2", "A3", "C"), q090 := qBB(0.90, bd = n, mu = mu, sigma = sigma, lower.tail = TRUE, log.p = FALSE)]
res[model %in% c("A1", "A2", "A3", "C"), q095 := qBB(0.95, bd = n, mu = mu, sigma = sigma, lower.tail = TRUE, log.p = FALSE)]
res[model %in% c("A1", "A2", "A3", "C"), q0975 := qBB(0.975, bd = n, mu = mu, sigma = sigma, lower.tail = TRUE, log.p = FALSE)]
...
res = res[, .(bias = mean(k/n - mu), mae = mae(k/n, mu), rmse = rmse(k/n, mu), coverage50 = mean(coverage50),
              coverage80 = mean(coverage80), coverage90 = mean(coverage90), coverage95 = mean(coverage95),
              logLik = mean(score)), by = .(model)]
