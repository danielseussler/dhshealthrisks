...
shp_madagascar = readRDS(file = file.path("data", "processed", "madagascar", "dhsboundaries.rds"))
shp_ethiopia = readRDS(file = file.path("data", "processed", "ethiopia", "dhsboundaries.rds"))
