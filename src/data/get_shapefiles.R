...
saveRDS(object = ethiopia, file = here("data", "processed", "ethiopia", "regions.rds"))
...
# load dhs data from spatial repository
ethiopia = read_sf(here("data/raw/sdr_subnational_boundaries_2022-11-26_ethiopia_2019_dhs/sdr_subnational_boundaries.shp"))
